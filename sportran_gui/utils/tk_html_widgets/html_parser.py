...
class Defs():
    ...
    HEADINGS_FONT_SIZE = {'h1': 21, 'h2': 16, 'h3': 12, 'h4': 11, 'h5': 8, 'h6': 7,}
...
class HTML:
    ...
    HEADING_TAGS = (Tag.H1, Tag.H2, Tag.H3, Tag.H4, Tag.H5, Tag.H6,)

    TEXT_ALIGN_TAGS = HEADING_TAGS + (Tag.UL, Tag.OL, Tag.LI, Tag.DIV, Tag.P, Tag.PRE, Tag.CODE,)

    NEW_LINE_TAGS = HEADING_TAGS + (Tag.UL, Tag.OL, Tag.DIV, Tag.P, Tag.PRE, Tag.CODE,)

    STYLE_TAGS = TEXT_ALIGN_TAGS + (Tag.A, Tag.B, Tag.STRONG, Tag.I, Tag.EM, Tag.U, Tag.MARK, Tag.SPAN,)
